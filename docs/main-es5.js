...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppDrumkitChoiceDrumkitChoiceComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _order_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./order-enum */
    ...
    function () {
      ...
      _createClass(DrumkitChoiceComponent, [{
        ...
        value: function isButtonDisabled(input) {
  ...
  /***/
  function srcAppDrumkitChoiceOrderEnumTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "OrderOptions", function () {
      return OrderOptions;
    });
    /* harmony import */
  ...
  /***/
  function srcAppPlayCanvasTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _tensorflow_models_posenet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    function () {
      ...
      _createClass(Canvas, [{
        ...
        value: function drawVideo(video) {
          ...
          this.ctx.drawImage(video, 0, 0, video.clientWidth, video.clientHeight); // this.drawVideo(video);
        }
      }, {
        key: "drawKeyPoints",
        value: function drawKeyPoints(pose) {
          var _this2 = this;

          pose.keypoints.forEach(function (keypoint, keypointIndex) {
            if (keypoint.score > _this2.minConfidence) {
              _this2.drawCircle(Math.round(keypoint.position.x), Math.round(keypoint.position.y), 5);

              if (keypointIndex == 9 || keypointIndex == 10) {
                _this2.drawCircle(Math.round(keypoint.position.x), Math.round(keypoint.position.y), 25, '#0000FF');
              }
            }
          });
        }
        ...
        value: function drawSkeleton(pose) {
          ...
          var adjacentKeyPoints = _tensorflow_models_posenet__WEBPACK_IMPORTED_MODULE_1__["getAdjacentKeyPoints"](pose.keypoints, this.minConfidence);

          adjacentKeyPoints.forEach(function (keypoints) {
            _this3.drawLine(keypoints[0].position.x, keypoints[0].position.y, keypoints[1].position.x, keypoints[1].position.y, '#00FF00');
          });
        }
      }, {
        key: "drawLine",
        value: function drawLine(ax, ay, bx, by) {
          var color = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : this.strokeColor;
          var strokeWeight = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 1;
        ...
        value: function drawCircle(x, y, radius) {
          var fillColor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : this.fillColor;
          var strokeColor = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : this.strokeColor;
          this.ctx.beginPath();
        ...
        value: function background() {
          var color = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.fillColor;
  ...
  /***/
  function srcAppPlayCameraUtilsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "loadVideo", function () {
      return loadVideo;
    });
    /* harmony import */
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                throw new Error("This browser does not support video capture, or this device does not have a camera. ERROR: ".concat(_context2.t0));
  ...
  /***/
  function srcAppPlayMlUtilsTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "loadNeuralNetwork", function () {
      return loadNeuralNetwork;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "detectPose", function () {
      return detectPose;
    });
    /* harmony import */
    ...
    var _tensorflow_models_posenet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! @tensorflow-models/posenet */
    "./node_modules/@tensorflow-models/posenet/dist/posenet.esm.js"); // export async function loadNeuralNetwork(): Promise<object> {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return _tensorflow_models_posenet__WEBPACK_IMPORTED_MODULE_1__["load"]();
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return network.estimateSinglePose(video, {
  ...
  function srcAppPlayPlayComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _Canvas__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./Canvas */
    "./src/app/play/Canvas.ts");
    /* harmony import */


    var _camera_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./camera.utils */
    "./src/app/play/camera.utils.ts");
    /* harmony import */


    var _ml_utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./ml.utils */
    "./src/app/play/ml.utils.ts");
    /* harmony import */


    var _drum_kit_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../drum-kit.service */
    "./src/app/drum-kit.service.ts");
    ...
    /*#__PURE__*/
    function () {
      function PlayComponent(ngZone, drumKitService, router) {
      ...
      _createClass(PlayComponent, [{
            ...
            return regeneratorRuntime.wrap(function _callee6$(_context6) {
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 4:
                    this.audioElements = _context6.sent;

                  case 5:
                    _context6.next = 7;
                    return Object(_camera_utils__WEBPACK_IMPORTED_MODULE_4__["loadVideo"])(this.videoRef.nativeElement);
                  ...
                  case 7:
                    ...
                    this.prepareCanvas();
                    _context6.next = 12;
                    return Object(_ml_utils__WEBPACK_IMPORTED_MODULE_5__["loadNeuralNetwork"])();

                  case 12:
                    this.network = _context6.sent;
                        ...
                        return regeneratorRuntime.wrap(function _callee5$(_context5) {
                          while (1) {
                            switch (_context5.prev = _context5.next) {
                              case 0:
                                _context5.next = 2;
                                return this.evaluatePoseAndDraw();
            ...
            return regeneratorRuntime.wrap(function _callee7$(_context7) {
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    return _context7.abrupt("return", Promise.all(this.selectedDrumKit.samples.map(function (sample) {
                      return new Promise(function (resolve) {
                        var audio = new Audio(sample.path);
        ...
        key: "evaluatePoseAndDraw",
        value: function evaluatePoseAndDraw() {
          return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0,
          /*#__PURE__*/
            ...
            return regeneratorRuntime.wrap(function _callee8$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    this.canvas.drawVideo(this.video); // this.pose = await detectPose(this.network, this.video);
